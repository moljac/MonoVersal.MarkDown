...
namespace MarkdownDeep
{
	...
	public class StringScanner
	{
		...
		{
			return 
				//string.Compare(str, Substring(position, str.Length), true) == 0
				string.Compare(str.ToLower(), Substring(position, str.Length).ToLower()) == 0
				;
		}
		...
		public bool SkipFootnoteID(out string id)
		{
			...
			if (position > mark)
			{
				...
				if (null != id && id != System.String.Empty)
				{
					SkipLinespace();
					return true;
				}
