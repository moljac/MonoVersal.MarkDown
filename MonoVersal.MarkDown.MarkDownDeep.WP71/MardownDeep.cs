...
namespace MarkdownDeep
{
	...
	public partial class Markdown
	{
		...
		public virtual string OnQualifyUrl(string url)
		{
			...
			if (null != UrlBaseLocation && UrlBaseLocation != System.String.Empty)
				return url;
			...
			if (url.StartsWith("/"))
			{
				...
				if (null != UrlRootLocation && UrlRootLocation != System.String.Empty)
				{
		...
		internal string MakeUniqueHeaderID(string strHeaderText, int startOffset, int length)
		{
			...
			if (null != strBase && strBase != System.String.Empty)
				strBase = "section";
